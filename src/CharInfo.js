...
import {updateName, updateAlignment, updatePlayerName, updatePlayerClass, updateLevel, updateDiety, updateHomeland, updateRace, updateSize, updateGender, updateAge, updateHeight, updateWeight, updateHair, updateEyes} from './js/actions/index';
